...
public class SentenceService {
    ...
    public ApiResponse<Void> registerScript(SentenceRequestDto.ScriptRegisterDto dto) {
        ...
        String inputPrompt = """
                ...
                내용을 요약하지 말고 <문장번호> <문장에서의 의미단위 번호> <스크립트 내용> <스크립트 내용에 대한 요약>
                이 포맷으로 해서 주는데 스크립트 내용에 대한 요약을 4~5단어로 해서 추출해줘.
                이 요약을 추출할 때에는 스크립트 언어를 고려해서 그 언어로 추출해서 줘. 
                스크립트 내용이 영어 스크립트면 영어로 요약하고, 한국어 내용 스크립트면 한국어로 요약.
                스크립트 내용이 한국어일 때 아래 예시야. 
                1 / 1 / 하지만 스마트폰을 너무 오래 사용하면 / 스마트폰 오래 사용 
                1 / 2 / 집중력이 떨어지고 피로해질 수 있습니다. / 집중력 저하 및 피로 
                영어면 이 내용이 영어로 바뀌면 되겠지? 내용뿐만아니라 요약도 영어로 추출해야해!
                이런식으로 해서 답변만줘
